...
imagenes_dados = [pygame.image.load(f"C:/Users/Jorgelina/Desktop/imagenes/dados/dado{i}.png") for i in range(1, 7)]
...
def evaluar_ronda():
    ...
    #Guardar esta informaciópn en la variable resultado en forma de texto.
